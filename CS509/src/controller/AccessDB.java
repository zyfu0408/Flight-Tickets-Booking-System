...
/**
 * Contains methods used for access the data base
 *
 */
class QueryFactory {
...
public class AccessDB {
	...
	/**
	 * Send lock request to DB then get access resutl from the DB
	 * 
	 * Return the access result of the request.
	 * 
	 * @param ticketAgency identifies the ticket agency requesting the information
	 * @return True if the DB access successes and false if not
	 */
	...
	/**
	 * Send unlock request to the DB then get access result from DB.
	 * 
	...
	/**
	 * 
	 * Send ticket reserved request to DB then get access result from DB
	 * 
	 * Return the access result of the request
	 * 
	 * 
	 * @param ticketAgency identifies the ticket agency requesting the information
	 * @param xmlFile string listing all Flights
	 * @return true if the DB access successes and false if not.
	 */
